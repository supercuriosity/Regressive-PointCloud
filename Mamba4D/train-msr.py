...
def evaluate(model, criterion, data_loader, device):
    ...
    logger.info(' * Clip Acc@1 {top1.global_avg:.3f} Clip Acc@5 {top5.global_avg:.3f}'.format(top1=metric_logger.acc1, top5=metric_logger.acc5))
    ...
    logger.info(' * Video Acc@1 %f'%total_acc)
    logger.info(' * Class Acc@1 %s'%str(class_acc))
...
def main(args):
    ...
    model = Model(radius=args.radius, nsamples=args.nsamples, spatial_stride=args.spatial_stride,
                  ...
                  dim=args.dim,mlp_dim=args.mlp_dim, num_classes=dataset.num_classes,
...
def parse_args():
    ...
    parser.add_argument('--output_dir', default='/data/MAMBA4D/output/mamba/', type=str, help='path where to save')
    # resume
