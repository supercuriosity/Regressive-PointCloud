...
parser.add_argument('--input', default='/data2/NTU120RGBD/Masked_depth_maps/nturgb+d_depth_masked', type=str)
parser.add_argument('--output', default='/data2/NTU120RGBD/pointcloud/', type=str)
...
def process_video(video_path, output_dir):
    ...
    # Save the point clouds for this video
